...
public class QMemberAgree extends EntityPathBase<MemberAgree> {
    ...
    private static final long serialVersionUID = -675571548L;
    ...
    public final com.umcpractice.chapter_5.domain.terms.entity.QTerms terms;
    ...
    public QMemberAgree(Class<? extends MemberAgree> type, PathMetadata metadata, PathInits inits) {
        ...
        this.terms = inits.isInitialized("terms") ? new com.umcpractice.chapter_5.domain.terms.entity.QTerms(forProperty("terms")) : null;
    }
