...
public class QMemberMission extends EntityPathBase<MemberMission> {
    ...
    private static final long serialVersionUID = -1719976988L;
    ...
    public final com.umcpractice.chapter_5.domain.mission.entity.QMission mission;
    ...
    public QMemberMission(Class<? extends MemberMission> type, PathMetadata metadata, PathInits inits) {
        ...
        this.mission = inits.isInitialized("mission") ? new com.umcpractice.chapter_5.domain.mission.entity.QMission(forProperty("mission"), inits.get("mission")) : null;
    }
