...
public class QMemberPrefer extends EntityPathBase<MemberPrefer> {
    ...
    private static final long serialVersionUID = 673856525L;
    ...
    public final com.umcpractice.chapter_5.domain.food_category.QFoodCategory foodCategory;

    public final NumberPath<Long> id = createNumber("id", Long.class);

    public final com.umcpractice.chapter_5.domain.member.entity.QMember member;
    ...
    public QMemberPrefer(Class<? extends MemberPrefer> type, PathMetadata metadata, PathInits inits) {
        ...
        this.foodCategory = inits.isInitialized("foodCategory") ? new com.umcpractice.chapter_5.domain.food_category.QFoodCategory(forProperty("foodCategory")) : null;
        this.member = inits.isInitialized("member") ? new com.umcpractice.chapter_5.domain.member.entity.QMember(forProperty("member")) : null;
    }
