...
public class QMemberMission extends EntityPathBase<MemberMission> {
    ...
    private static final long serialVersionUID = -1101949188L;
    ...
    public final mju_umc.mju_umc.domain.QMember member;

    public final mju_umc.mju_umc.domain.QMission mission;

    public final EnumPath<mju_umc.mju_umc.domain.enums.MissionStatus> status = createEnum("status", mju_umc.mju_umc.domain.enums.MissionStatus.class);
    ...
    public QMemberMission(Class<? extends MemberMission> type, PathMetadata metadata, PathInits inits) {
        ...
        this.member = inits.isInitialized("member") ? new mju_umc.mju_umc.domain.QMember(forProperty("member")) : null;
        this.mission = inits.isInitialized("mission") ? new mju_umc.mju_umc.domain.QMission(forProperty("mission"), inits.get("mission")) : null;
    }
