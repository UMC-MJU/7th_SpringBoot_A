...
public class QReviewImage extends EntityPathBase<ReviewImage> {
    ...
    private static final long serialVersionUID = 310484058L;
    ...
    public final mju_umc.mju_umc.domain.QReview review;
    ...
    public QReviewImage(Class<? extends ReviewImage> type, PathMetadata metadata, PathInits inits) {
        ...
        this.review = inits.isInitialized("review") ? new mju_umc.mju_umc.domain.QReview(forProperty("review"), inits.get("review")) : null;
    }
