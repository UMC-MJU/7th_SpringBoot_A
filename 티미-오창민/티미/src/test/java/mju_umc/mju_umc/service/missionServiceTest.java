...
public class missionServiceTest {
    ...
    @Test
    public void getClearOrProgressMissionByMemberTest() {
        //given
        ...
        List<Mission> missions = missionService.getClearOrProgressMissionByMember(MissionStatus.CHALLENGING, member);


        //then
        //DB에서 CHALLENGING 상태의 미션의 개수는 2개이다.
